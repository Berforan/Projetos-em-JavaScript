          ...
          >
            <Animated.View style={[styles.card, { transform: [{ scale: scaleValue }] }]}>
              ...
              <View style={styles.placeInfo}>
                ...
                <Text style={styles.placeDetail}>Experiências: Atuante há 5 anos com serviços de limpeza</Text>
                <Text style={styles.placeLocation}>Região de Rio de janeiro, Rj</Text>
        ...
        <View style={styles.serviceDetails}>
          ...
          <TouchableOpacity onPress={() => navigation.navigate('CheckStand', { 
              servant: {
                ...
                rating: 4.9,
                reviews: '18k',
                image: 'https://drive.google.com/file/d/13GFKVlABo6lDS16UyGN_PaB8lYVk9G0X/view?usp=sharing'
              }
            })}>
          ...
          <TouchableOpacity onPress={() => navigation.navigate('CheckPrem', { 
              servant: {
                ...
                rating: 4.9,
                reviews: '18k',
                image: 'https://drive.google.com/file/d/1o04r4XXIougH3ezn14W9g88P6R8payUW/view?usp=sharing'
              }
            })}>
            <View style={styles.serviceCardWrapper}>
              <ImageBackground
          ...
          <BlurView intensity={50} tint="light" style={styles.securityCard}>
            ...
            <View style={styles.securityTextWrapper}>
              ...
              <Text style={styles.securityText}>
                A Clean preza pela responsabilidade com cada cliente. Garantimos total segurança e qualidade nos nossos serviços. Nossas profissionais são altamente qualificadas e garantem um serviço 100% completo.
              </Text>
            </View>
          </BlurView>
        </View>
